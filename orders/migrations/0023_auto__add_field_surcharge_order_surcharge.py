...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Surcharge.order_surcharge'
        db.add_column('orders_surcharge', 'order_surcharge',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Surcharge.order_surcharge'
        db.delete_column('orders_surcharge', 'order_surcharge')
    ...
    models = {
        ...
        'orders.orderitem': {
            ...
            'user_order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.UserOrder']", 'related_name': "'order_items'"})
        },
        ...
        'orders.surcharge': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_surcharge': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '6', 'decimal_places': '2'}),
