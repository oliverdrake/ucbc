...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SingleIngredientOrder.quantity'
        db.alter_column('orders_singleingredientorder', 'quantity', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'SingleIngredientOrder.quantity'
        db.alter_column('orders_singleingredientorder', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        'orders.ingredient': {
            ...
            'supplier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ingredients'", 'default': 'None', 'to': "orm['orders.Supplier']", 'null': 'True'}),
